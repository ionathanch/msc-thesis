\newcommand{\FigCongRed}[1]{
  ...
  \inferrule{
    ...
    \red*{\Phi; \Gamma}{\app{e_1}{e_2}}{\app{e'_1}{e'_2}}
  }
  \and
  \inferrule{
    \red*{\Phi; \Gamma}{\sigma}{\sigma'} \\
  ...
  \inferrule{
    ...
    \red*{\Phi; \Gamma}{\sup{x}{\sigma}{\tau}{s}{r}{e_1}{e_2}}{\sup{x}{\sigma'}{\tau'}{s}{r}{e'_1}{e'_2}}
  }
  \end{mathpar}
}
...
\newcommand{\FigCongEquiv}[1]{
  ...
  \inferrule{
    ...
    \defeq{\GammaT}{\app{\eT_1}{\eT_2}}{\app{\eT'_1}{\eT'_2}}{\subst{\tauT}{\xT}{\eT'_2}}
  }
  \and
  \inferrule{
  ...
  \inferrule{
    ...
    \defeq{\GammaT, \defineT{\xT}{\sigmaT'}{\eT'_1}}{\eT_2}{\eT'_2}{\tauT}
  }{
    \defeq{\GammaT}{\letinT{\xT}{\sigmaT}{\eT_1}{\eT_2}}{\letinT{\xT}{\sigmaT'}{\eT'_1}{\eT'_2}}{\subst{\tauT}{\xT}{\eT'_1}}
  }
  \and
  \inferrule{
