...
\begin{proof}
  ...
  the proof structure is similar to that of \cref{lem:weakening}.
...
Suppose $\type{\Gamma_1}{e}{\sigma}$ and that there is no $e_x$
...
\begin{proof}
The proof structure is similar to that of \cref{lem:replacement-subtyping}.
