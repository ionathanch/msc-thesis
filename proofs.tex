...
\end{itemize}
Then $\type{\compile{\Phi}\compile{\Gamma}}{\compile{e'}}{\compile{tau}}$,
...
\begin{sublemma}[Strong type preservation across closure of reduction]
...
\begin{itemize}[noitemsep, label=\textbf{Case}, leftmargin=*, labelindent=\parindent]
  \item \rref*{red*-once}. By \TODO. % Strong type preservation across reduction
  \item \rref*{red*-refl}. Trivial.
  \item \rref*{red*-trans}.
    \vspace{-\baselineskip}
    \begin{mathpar}
  ...
  \item \rref*{red*-cong}.
    ...
    \begin{itemize}[noitemsep, label=\textbf{Case}, leftmargin=*, labelindent=\parindent]
      \item \rref*{let}.
        ...
        \end{mathpar}
        By definition, all three premises are strongly type preserved as well.
        Then by the induction hypothesis on the first two premises of both derivations, we have
        \begin{itemize}[noitemsep]
          \item $\type{\Phi; \Gamma}{\sigma'}{U}$ is strongly type preserved, and
          \item $\type{\Phi; \Gamma}{e'_1}{\sigma}$ is strongly type preserved.
        \end{itemize}
        We have $\subtype{\Phi; \Gamma}{\sigma}{\sigma'}$ by the first reduction premise and
        \rref{red*-refl, acum-refl},
        so we have $\type{\Phi; \Gamma}{e'_1}{\sigma'}$ by \rref{conv}.
        Furthermore, we have $\infer{\Phi; \Gamma, \define{x}{\sigma'}{e'_1}}{e_2}{\tau}$
        by the third typing premise, \nameref{lem:replacement-subtyping},
        and \nameref{lem:replacement-reduction}.
        Then we can apply the induction hypothesis once more on the third reduction premise
        to get that $\infer{\Phi; \Gamma, \define{x}{\sigma'}{e'_1}}{e'_2}{\tau}$
        is strongly type preserved.
        Putting it all together with \rref{let, let*}, we have
        \begin{itemize}[noitemsep]
          \item $\type{\Phi; \Gamma}{\letin{x}{\sigma'}{e'_1}{e'_2}}{\subst{\tau}{x}{e'_1}}$
          is strongly type preserved, and
          \item $\type{\compile{\Phi}\compile{\Gamma}}{\letinT{\xT}{\compile{\sigma'}}{\compile{e'_1}}{\compile{e'_2}}}{\subst{\compile{\tau}}{\xT}{\compile{e'_1}}}$.
        \end{itemize}
        By the second reduction premise and \rref{red*-cong, red*-refl, acum-refl},
        we have that
        $$\subtype{\Phi; \Gamma}{\subst{\tau}{x}{e'_1}}{\subst{\tau}{x}{e_1}}$$
        holds. Finally, using \rref{conv}, we have that % TODO: this doesn't seem right
        $$\type{\Phi; \Gamma}{\letin{x}{\sigma'}{e'_1}{e'_2}}{\subst{\tau}{x}{e_1}}$$
        is strongly type preserved.
      \item \rref*{conv}.
        \vspace{-\baselineskip}
        \begin{mathpar}
          \inferrule{
            \dots \\
            \infer{\Phi; \Gamma}{\letin{x}{\sigma}{e_1}{e_2}}{\tau'} \\
            \subtype{\Phi; \Gamma}{\tau'}{\tau}
          }{
            \check{\Phi; \Gamma}{\letin{x}{\sigma}{e_1}{e_2}}{\tau}
          }
        \end{mathpar}
...
By induction on the derivation of $\red*{\Phi; \Gamma}{e}{e'}$.
\begin{itemize}[noitemsep, label=\textbf{Case}, leftmargin=*, labelindent=\parindent]
  \item \rref*{red*-once}. By \TODO. % Preservation of reduction
