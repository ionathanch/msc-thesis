...
\begin{itemize}[noitemsep, label=\textbf{Case}, leftmargin=*, labelindent=\parindent]
  ...
  \item \rref*{acum-pi}.
    ...
    \end{itemize}
    Finally, by \rref{red*-cong, acum-pi}, we have
    \begin{itemize}[noitemsep]
...
$\red*{\Phi; \Gamma_1, \define{x}{\sigma}{e_1}, \Gamma_2}{e_2}{e'_2}$.
The \rref{red*-once} case holds by \cref{lem:replacement-reduction-1},
the \rref{red*-refl} case by \rref{red*-refl},
and the \rref{red*-cong} cases straightforwardly by their induction hypotheses.
...
&\tau_1
  \arrow[dl, dashrightarrow]
  \arrow[d, dashrightarrow]
  \arrow[r, dotted, no head, "\preccurlyeq" description]
&\tau_2
  \arrow[dr, dashrightarrow]
  \arrow[d, dashrightarrow] \\
\tau''_1
...
\begin{enumerate}[noitemsep]
  \item %
    \begin{itemize}[noitemsep, label=\textbf{Case}, leftmargin=*, labelindent=\parindent]
      ...
      \item \rref*{cons-size<}. By the induction hypotheses and \rref{ind, cons*-ass} twice.
    \end{itemize}
  \item %
    \begin{itemize}[noitemsep, label=\textbf{Case}, leftmargin=*, labelindent=\parindent]
      ...
      \item $\wf{\Phi}{\sss{s}}$. By the induction hypothesis and \rref{constr}.
    \end{itemize}
\end{enumerate}
\end{proof}
