...
upon which \CICE is based, we don't include them in \lang either,
...
Here, we define the classic example of coinductive streams,
...
We've seen from \cref{subsec:examples:limitations} that working without an infinite size
...
In this thesis, we introduced \lang, a sized dependent type theory
