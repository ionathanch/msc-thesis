...
\and \inferrule*[left=\rlabel{$\rhd$-cong}{red-cong}]{
  \red{\Phi'; \Gamma'}{e'}{e''}
}{
  \red{\Phi; \Gamma}{\subst{e}{x}{e'}}{\subst{e}{x}{e''}}
}
\\
\inferrule*[left=\rlabel{$\rhd^*$-once}{red*-once}]{
  \red{\Phi; \Gamma}{e_1}{e_2}
}{
  \red*{\Phi; \Gamma}{e_1}{e_2}
}
\quad
\inferrule*[left=\rlabel{$\rhd^*$-refl}{red*-refl}]{~}{\red*{\Phi; \Gamma}{e}{e}}
\quad
\inferrule*[left=\rlabel{$\rhd^*$-trans}{red*-trans}]{
  \red*{\Phi; \Gamma}{e_1}{e_2} \\
...
We also omit the type annotation of $\kw{let}$-bound expressions
...
of accessibility predicates is required---all proofs of accessibility are
definitionally equal.
This holds in extensional type theory via equality reflection
but not in intensional type theory, hence our use of
extensional CIC.
...
see, \eg, pCIC~\citep{pCIC} for a full description.
