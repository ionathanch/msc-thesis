...
\footnotetext[5]{\label{foot:CICE-consistency} Under the postulate that \CICE is consistent.}
...
\textsuperscript{\labelcref{foot:agda-inconsistent}}.
(Interestingly, \Fcopomega~\citep{F-omega-cop}, which extends System F$_\omega$ with sized types,
