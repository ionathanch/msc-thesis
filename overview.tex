...
\citet{pCIC} give a set-theoretic model for the \emph{Predicative Calculus of Inductive Constructions}\index{Calculus of Inductive Constructions!Predicative \textasciitilde} (pCIC),
...
\citet{CCE} adds a propositional equality type with equality reflection to \GCC with \rref{cum},
