...
adding a universe hierarchy to CC and using \rref{cum} for cumulativity.
...
\rref{untyped-subtype-pi} is the most notable subtyping rule.
...
and without an \emph{impredicative $\Set$} universe from version 8 onwards \citep{Coq-manual}.
...
\citet{pCIC} give a set-theoretic model for a variant of pCIC with a typed equality judgement.
...
using ECC with a propositional equality type, a typed equality judgement,
...
% TODO: mention MLTT somewhere above
