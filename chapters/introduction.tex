...
is that recursive functions must be \emph{guarded by destructors}\index{guarded by destructors}
...
(as is the case with an impredicative, definitionally proof-irrelevant $\Prop$ universe~\citep{impred-proof-irrel}),
...
The one that this thesis discusses is \emph{sized typing}\punctstack{,}%
...
This thesis then introduces \lang,
