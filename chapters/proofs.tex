...
Note that the term being substituted in must be $e$.
\end{corollary}
...
(of which there is only one case for each derivation below).
\begin{mathpar}
\inferrule{
...
\begin{itemize}[noitemsep, label=\textbf{Case}, leftmargin=*, labelindent=\parindent]
  \item $\mathcal{R} \neq \rref*{conv}$. The premises of the derivation are the desired ones,
