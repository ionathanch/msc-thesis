...
Choosing to use a syntactic model imposes some contraints on the design
...
which would otherwise require a large and complex mutual proof of type preservation.
On the other hand, there's no similar restriction on the target,
...
a part of $\rhd$ and not of $\rhd^*$ (as is the case in the languages compiled in \citet{wjb}).
