...
I include them so that they validate the various extensions I add to \lang later in \TODO.
% TODO: forward ref to chapter on extensions
...
The remaining definitions have been mechanized in either Agda and Coq in \TODO,
% TODO: forward ref to appendix with code
...
Since $\AccT$ is in already $\PropT$, the target language could be replaced by an intensional CIC
...
but likely not consistency,
which as a target language of a syntactic model for proving consistency
is the relevant metatheoretical property.
In any case, I use \CICE because it's more established, more well-known,
and definitely consistent.
